...
public class SettingsControllerTest extends ApplicationTest {
	...
	public void start(Stage stage) throws Exception {
		...
		Parent root = FXMLLoader
				.load(getClass().getResource("/fxml/SettingsScreen.fxml"));
	...
	public void testButtonsExist() {
		verifyThat("#sfxSlider", isNotNull());
		verifyThat("#backgroundSlider", isNotNull());
		verifyThat("#backButton", isNotNull());
		verifyThat("#muteBox", isNotNull());
		verifyThat("#hour24Toggle", isNotNull());
	}
